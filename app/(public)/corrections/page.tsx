    ...
    >
      <div className="grid gap-6 lg:grid-cols-3">
        <article className="panel p-6">
          ...
          <h2 className="mt-3 font-display text-3xl text-charcoal">The page link and the issue.</h2>
        ...
        <article className="panel p-6">
          ...
          <h2 className="mt-3 font-display text-3xl text-charcoal">We review, update, or pull it back.</h2>
          <p className="mt-4 text-sm leading-7 text-charcoal/75">
        ...
        <article className="panel p-6">
          ...
          <h2 className="mt-3 font-display text-3xl text-charcoal">Freshness is part of trust.</h2>
          <p className="mt-4 text-sm leading-7 text-charcoal/75">
      ...
      <div className="panel p-8">
        ...
        <h2 className="mt-3 font-display text-4xl text-charcoal">Corrections should be easy to send.</h2>
