    ...
    >
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <article className="panel p-6">
          ...
          <h2 className="mt-3 font-display text-3xl text-charcoal">Where does the heat land in context?</h2>
          <p className="mt-4 text-sm leading-7 text-charcoal/75">
        ...
        <article className="panel p-6">
          ...
          <h2 className="mt-3 font-display text-3xl text-charcoal">Who is the bottle actually for?</h2>
          <p className="mt-4 text-sm leading-7 text-charcoal/75">
      ...
      <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <article className="panel p-8">
          ...
          <h2 className="mt-3 font-display text-4xl text-charcoal">They are not the same as explainers or recipes.</h2>
        ...
        <article className="panel p-8">
          ...
          <h2 className="mt-3 font-display text-4xl text-charcoal">Keep the methodology in context.</h2>
